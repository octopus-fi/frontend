      ...
      >
        <Card className="glass border-primary/20">
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-3xl font-bold mb-3">Create Your First Vault</h3>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              A vault allows you to deposit octSUI as collateral and borrow
              octUSD stablecoin against it. You can only have one vault per
              collateral type.
            </p>
        ...
        >
          <Card className="glass">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Borrow up to 70% of your collateral value in octUSD stablecoin
                at 0% interest
              </p>
            </CardContent>
          </Card>
        ...
        >
          <Card className="glass">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Optional AI agent can automatically manage your vault to prevent
                liquidation
              </p>
            </CardContent>
          </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your octSUI continues earning staking rewards while locked as
                  collateral
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Mint octUSD stablecoin worth up to 70% of your collateral
                  value
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Keep your LTV below 70% to avoid liquidation. AI can help
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold mb-1">Repay and Withdraw</h4>
                <p className="text-sm text-muted-foreground">
                  Repay your debt anytime to unlock and withdraw your collateral
                </p>
              </div>
            </div>
          </CardContent>
