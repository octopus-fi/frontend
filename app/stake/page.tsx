                              ...
                              <Button
                                ...
                                onClick={() =>
                                  setAmount(
                                    mode === "stake"
                                      ? "50000"
                                      : stakingStats.userOctSUI.toString(),
                                  )
                                }
                              >
                                MAX
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium font-mono text-green-500">
                          +
                          {(
                            stakingStats.userOctSUI - stakingStats.userStaked
                          ).toFixed(2)}{" "}
                          SUI
                        </span>
                      </div>
                  ...
                  <Card className="glass border-primary/20 bg-primary/5">
                    <CardContent className="p-6 text-center">
                      ...
                      <h3 className="font-semibold mb-2">
                        Use octSUI in Vaults
                      </h3>
                      <p className="text-sm text-muted-foreground mb-4">
                        Deposit octSUI as collateral and borrow octUSD at 0%
                        interest
                      </p>
